...
const VERSAO = "treino-1.1.3";
const ARQUIVOS = ["./", "./index.html", "./app.js", "./forca.js", "./forca_auto.js", "./gerador.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png"];
